...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_NONE, ABILITY_THICK_FAT },
    ...
    [SPECIES_PIDOVE] =
    {
        ...
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_NONE, ABILITY_RIVALRY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DRUDDIGON] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_DRAGONS_MAW, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 54, SPECIES_KINGAMBIT}),
    },
