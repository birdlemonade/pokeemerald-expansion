...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 140 : 80)
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_MAGMAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM_HOLD, ITEM_MAGMARIZER, SPECIES_MAGMORTAR},
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_ADAPTABILITY, ABILITY_MARVEL_SCALE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_MULTISCALE, ABILITY_AERILATE, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
