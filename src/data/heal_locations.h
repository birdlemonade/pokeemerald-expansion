static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PORYTILES_TESTING_GROUND - 1] = {MAP_GROUP(PORYTILES_TESTING_GROUND), MAP_NUM(PORYTILES_TESTING_GROUND), 10, 10},
    [HEAL_LOCATION_LEUMENA_TOWN - 1] = {MAP_GROUP(LEUMENA_TOWN), MAP_NUM(LEUMENA_TOWN), 15, 15},
};
