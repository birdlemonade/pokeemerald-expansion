...
const u32 gObjectEventPicHexManiac_New[] = INCBIN_U32("graphics/object_events/pics/people/hex_maniac_new.4bpp");
const u16 gObjectEventPalette_Hex[] = INCBIN_U16("graphics/object_events/pics/people/hex.gbapal");
